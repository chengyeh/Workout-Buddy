...
class GroupMember extends DatabaseObject {
    ...
    public $id; /*!< A 11-bit INT variable keeping track of group members ID*/
    public $group_id; /*!< A 11-bit INT variable keeping track of groups (wb_group) ID*/
    public $member_id; /*!< A 11-bit INT variable keeping track of group members (wb_users) ID*/
}
