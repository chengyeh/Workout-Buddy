...
//This test is to determine the full name of the user

//The following function to be tested:
...
//This test is to determine the authentication of test user
...
//This test is to determine if the user's status is active
...
//This test is to determine if the function can display all user logs
...
$pass_trigger=0;
$a=0;
while($test_array = $log_disp->fetch_assoc())
{
	if($test_array['id']==$test_cat->id)
	{
		$pass_trigger=1;
	}
...
//This test is to determine the groups the user owns
...
//This test is to determine the the groups the user joined
...
//This test is to determine the messages the user received
...
//This test is to determine the messages the user sent
...
//This test is to determine the exercise routine functionality of the user
...
//This test is to determine the the last routine of the user
...
//This test is to all the exercises of the user
...
//This test is to determine the last exercise of the user
...
//This test is to determine the name of the exercise type of the user
