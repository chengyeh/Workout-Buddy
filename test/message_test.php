...
<h3 class="expand sub-header">Test to send message</h3>
...
<div class="well" style="display:none;">
	<xmp>
//This test demonstrates the user receiving messages
...
<div class="well" style="display:none;">
	<xmp>
//This test demonstrates the deletion of messages using markers
...
<div class="well" style="display:none;">
	<xmp>
//This test demonstrates deleting messages that the user sent using markers
...
<h3 class="expand sub-header">Test for displaying inbox icon</h3>

<div class="well" style="display:none;">
	<xmp>
//This test demonstrates displaying an inbox icon in the navigation bar using markers
